...
void ui_event_back4(lv_event_t *e) {
    ...
    if (event_code == LV_EVENT_CLICKED) {
        ...
        lv_theme_t *theme = lv_theme_default_init(dispp, lv_color_hex(0x529d53), lv_palette_main(LV_PALETTE_RED), true,
                                                  LV_FONT_DEFAULT);
...
//lv_obj_set_style_text_font(ui_temp_unit_2, &ui_font_font0, LV_PART_MAIN| LV_STATE_DEFAULT);
    ...
    creat_scrolldots(ui_screen_sensor, 1);
...
void ui_screen_setting_screen_init(void) {
    ...
    creat_scrolldots(ui_screen_setting, 3);
...
void ui_screen_display_screen_init(void) {
    ...
    lv_obj_set_style_bg_color(ui_screen_always_on_cfg, lv_color_hex(0xFFFFFF),
...
//lv_obj_set_y( ui_auto_update, -60 );
    ...
    lv_obj_set_style_bg_color(ui_zone_auto_update_cfg, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_CHECKED | LV_STATE_PRESSED);
...
//lv_obj_set_y( ui_time_zone, 88 );
    ...
    lv_obj_set_style_bg_color(ui_daylight_cfg, lv_color_hex(0xFFFFFF),
                              LV_PART_MAIN | LV_STATE_CHECKED | LV_STATE_PRESSED);
...
void ui_screen_sensor_chart_screen_init() {
    ...
    ui_sensor_chart_day_series = lv_chart_add_series(ui_sensor_chart_day, lv_palette_main(LV_PALETTE_YELLOW),
                                                     LV_CHART_AXIS_PRIMARY_Y);
    lv_chart_set_series_color(ui_sensor_chart_day, ui_sensor_chart_day_series,
                              lv_palette_main(LV_PALETTE_GREEN)); //modify
    ...
    ui_sensor_chart_week_series_hight = lv_chart_add_series(ui_sensor_chart_week, lv_palette_main(LV_PALETTE_YELLOW),
                                                            LV_CHART_AXIS_PRIMARY_Y);
    ui_sensor_chart_week_series_low = lv_chart_add_series(ui_sensor_chart_week, lv_palette_main(LV_PALETTE_YELLOW),
                                                          LV_CHART_AXIS_PRIMARY_Y);
